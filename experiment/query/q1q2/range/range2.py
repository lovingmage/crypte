...
def evaluate_range(inputfile, num_DO, attr,r_start,r_end,e):
    ...
    #cPickle.dump(As,open("./32000-as.pkl","wb"))
    #cPickle.dump(csp,open("./32000-csp.pkl","wb"))
    ...
    start_P24 = time.time()
    ans_n=csp.Laplace([c2],0.05,1)
    #The following is I/O
    ...
    #return 
    print(abs(int(ans_t[0]) - int(ans_n[0])))
...
n = evaluate_range("adult.dataset.txt", 100, 1,50, 60, 0.1)
'''
