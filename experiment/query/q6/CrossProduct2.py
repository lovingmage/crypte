...
def evaluate_cp2(inputfile, num_DO,attr1,attr2, Q,e):
    ...
    print('Runtime(AS_Cros_Prod) = ', end_P24 - start_P24)
    print('Runtime(CSP_Lab_Prod) = ', end_P25 - start_P25)
    print('Runtime(AS_Group_by) = ', end_P26 - start_P26)
    print('Runtime(AS_add_noise) = ', end_P27 - start_P27)
